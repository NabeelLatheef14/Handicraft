...
<?php
    ...
    if(isset($_POST['widthraw'])){
        $amount = $_POST['amount'];
        $date = date("Y-m-d");
        $sql2=mysqli_query($con,"INSERT INTO tbl_transaction(transaction_date, transaction_type, transaction_amount, wallet_id, transaction_status) VALUES ('$date','Debit','$amount','0','1')");
