    ...
    <div class="content">
        ...
        <div class="main">
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        var data = google.visualization.arrayToDataTable([
                            ...
                            <?php
                            include("config.php");
                            $sql = mysqli_query($con, "SELECT i.item_name,SUM(t.transaction_amount) as sum FROM tbl_category c INNER JOIN tbl_item i ON i.category_id=c.category_id INNER JOIN tbl_cart_item ci ON ci.item_id=i.item_id INNER JOIN tbl_transaction t ON t.cart_item_id=ci.cart_item_id WHERE t.transaction_status='1' AND t.wallet_id!='0' AND i.shop_id='$Shop_id' GROUP BY i.item_name");
            ...
            <div class="right">
                <div class="head">
                    <h1>Report</h1>
                    <a href="item_report_export.php"><button>Export</button></a>
                </div>
                <div class="input">
                    ...
                    <select name="category" id="" class="category">
                        ...
                        <?php
                        $sql1 = mysqli_query($con, "SELECT * FROM tbl_item");
                        while ($display1 = mysqli_fetch_array($sql1)) {
                        ?>
                            <option value="<?php echo $display1['item_id'] ?>"><?php echo $display1['item_name'] ?></option>
                        <?php
                        }
                        ?>
                    </select>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="width: 20%;text-align: center;"><?php echo $display2['cart_item_quantity'] ?></td>
