            ...
            <div class="cards">
                <div class="transactions">
                    ...
                    <div class="details">
                        <?php
                            include("config.php");
                            $sql = mysqli_query($con,"SELECT * FROM tbl_transaction t LEFT JOIN tbl_cart_item ci ON ci.cart_item_id=t.cart_item_id LEFT JOIN tbl_item i ON i.item_id=ci.item_id LEFT JOIN tbl_shop s ON s.shop_id=t.wallet_id WHERE s.shop_id='$shop_id' ORDER BY t.transaction_id DESC");
                        ...
                        <div class="credit">
                            ...
                            <p>Credited amount by selling <?php echo $display['item_name'] ?> on <?php echo $display['transaction_date'] ?></p>
                        </div>
                        <?php
